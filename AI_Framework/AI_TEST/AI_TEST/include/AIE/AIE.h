...
//////////////////////////////////////////////////////////////////////////
DLLEXPORT unsigned int	CreateSprite( const char* a_pTextureName, int a_iWidth, int a_iHeight, bool a_bDrawFromCenter = false, SColour a_sColour = SColour(0xFF,0xFF,0xFF,0xFF) );
